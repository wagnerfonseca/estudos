...
public class ClientesImpl implements ClientesQueries {
	...
	public Page<Cliente> filtrar(ClienteFilter filtro, Pageable pageable) {
		...
		/* Para resolver o problema de lazyException
		 * JoinType.LEFT_OUTER_JOIN <- o tipo de associação que iremos utilizar.
		 * Para evitar erros nos casos onde não foram informados cidade/estado */
